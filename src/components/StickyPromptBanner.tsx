...
export const StickyPromptBanner = memo(function StickyPromptBanner({
  ...
  return (
    <Button
      ...
      title={prompt.text}
      className="motion-slide-down-in absolute left-1/2 top-12 z-20 h-9 max-w-[calc(100%-5rem)] -translate-x-1/2 justify-start gap-2 rounded-full bg-background px-3 text-left shadow-sm"
    ...
    >
      ...
      <span className="min-w-0 flex-1 truncate text-sm font-normal text-foreground/80">
        {prompt.text}
      </span>
